...
Por definición de divisibilidad, $r_n \mid r_{n-1}$. Entonces, por _Teorema 2.1 - Propiedad 3_, $r_n \mid r_{n-1} q_n$. Entonces, por _Teorema 2.1 - Propiedad 7_, $r_n \mid r_{n-2}$. Iterando de esta forma sobre todos los $r_i$ decreciendo el valor de $i$, se llega a que $r_n \mid a \wedge r_n \mid b$.
...
El máximo común divisor está definido cuando $a$ y $b$ no son ambos nulos, y el _Teorema 1.1_ requiere que $b$ no sea nulo.
